  ...
  return <>
    <Center style={{ height: '85vh' }}>
      <Box className="landing-page-box">
        ...
        <Image radius="md" style={{ width: '8vw' }} src={blueLogo} className="blue-logo"/>
        <Text style={{ fontSize: '3vw' }} fw={700} className="main-header">Say Hello To Your AI College Advisor</Text>
